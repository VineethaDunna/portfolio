...
const Footer: React.FC = () => {
	...
	const socialLinks = [
		{ icon: Github, href: "https://github.com/VineethaDunna", label: "GitHub" },
		{
			icon: Linkedin,
			href: "https://linkedin.com/in/vineethadunna",
			label: "LinkedIn",
		},
		{ icon: Mail, href: "mailto:dunnavineetha@gmail.com", label: "Email" },
	];
				...
				<div className='text-center space-y-8'>
					...
					<motion.div
						...
						<p className='flex items-center justify-center gap-2'>
							© {currentYear} Dunna Vineetha. Made with
