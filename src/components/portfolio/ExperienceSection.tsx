  ...
  const experiences: Experience[] = [
    {
      ...
      type: "Internship",
      responsibilities: [
        "Enhanced UI/UX of AI Browser Automation Chrome extension",
        "Developed auto-triggering with Chrome Alarms, Background Scripts & Notifications",
        "Implemented role-based privileges for DataViews, Automations & Recordings",
        "Resolved bugs and improved overall system stability",
        "Built Selenium automation workflows for content migration",
        "Scraped data and automated new design population"
      ]
    }
  ];
            ...
            >
              ...
              <div className="glass rounded-2xl p-8 ml-20 hover-lift border-l-4 border-l-primary/50">
                ...
                <div className="space-y-3">
                  <h4 className="font-semibold text-foreground/90 mb-3">Key Responsibilities:</h4>
